...
def run(settings):
    ...
    # Network
    net = joint_networks.steepest_descent_resnet50(filter_size=3, num_filters=16, optim_iter=5,
    ...
    lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[40, 80], gamma=0.2)
